		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#starttestuiworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"starttestuiworkflowuimodule-display": {
								"semanticObject": "starttestuiworkflowuimodule",
								"action": "display",
								"description": "A workflow start UI application",
								"title": "Test custom components",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=starttestui.workflowuimodule",
									"url": sap.ui.require.toUrl("starttestui/workflowuimodule")
								}
							}
						}
					}
