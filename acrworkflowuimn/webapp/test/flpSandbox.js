		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ACR Start UI app title",
									"targetURL": "#acrstartuiappnpacrworkflowuimn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"acrstartuiappnpacrworkflowuimn-display": {
								"semanticObject": "acrstartuiappnpacrworkflowuimn",
								"action": "display",
								"description": "An acr workflow start UI application",
								"title": "ACR Start UI app title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acrstartuiappnp.acrworkflowuimn",
									"url": sap.ui.require.toUrl("acrstartuiappnp/acrworkflowuimn")
								}
							}
						}
					}
