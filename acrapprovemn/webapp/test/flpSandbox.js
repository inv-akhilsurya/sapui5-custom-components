		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ACR Approve UI",
									"targetURL": "#acrapprovenpacrapprovemn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"acrapprovenpacrapprovemn-display": {
								"semanticObject": "acrapprovenpacrapprovemn",
								"action": "display",
								"description": "An acr workflow task UI application",
								"title": "ACR Approve UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acrapprovenp.acrapprovemn",
									"url": sap.ui.require.toUrl("acrapprovenp/acrapprovemn")
								}
							}
						}
					}
